                ...
                render: function (data, type, row) {
                    ...
                    if (data == "Safety Violation Pending") {
                        if (row.Role_Id == "9" || row.Role_Id == "10" || row.Role_Id == "11") {
                            html += '<a onclick="Edit_Safety_Violation(' + row.Safety_Violation_Id + ',' + "'" + 'Edit' + "'" + ',' + "'" + 'Access' + "'" + ')" href="javascript:void(0);" title="Edit" class="text-success" data-bs-original-title="Edit" aria-label="Edit" style="cursor: pointer;"> <i class="mdi mdi-pencil font-size-18"></i></a>';
                        }
                    }
                    if (data == "HSE Manager Approval Pending") {
                        if (row.Role_Id == "10") {
                            ...
                            html += '<a onclick="Edit_Safety_Violation(' + row.Safety_Violation_Id + ',' + "'" + 'View' + "'" + ',' + "'" + 'NoAccess' + "'" + ')" href="javascript:void(0);" title="View" class="text-success" data-bs-original-title="View" aria-label="View" style="cursor: pointer;"> <i class="mdi mdi-eye font-size-18"></i></a>';
                        }
                        html += '<a onclick="Fn_Insp_SV_Pre_Report(' + row.Safety_Violation_Id + ',' + "'" + row.Unique_Id + "'" + ')" style="cursor: pointer;"><i style="color: red;font-size: 18px" class="mdi mdi-file-pdf"></i></a>';
                    }
                    ...
                    if (data == "Corrective Action Pending") {
                        if (row.Responsible_Dept == "Service_provider") {
                            if (row.Emp_Service_provider == row.Login_Id) {
                                ...
                                html += '<a onclick="Edit_Safety_Violation(' + row.Safety_Violation_Id + ',' + "'" + 'View' + "'" + ',' + "'" + 'Access' + "'" + ')" href="javascript:void(0);" title="View" class="text-success" data-bs-original-title="View" aria-label="View" style="cursor: pointer;"> <i class="mdi mdi-eye font-size-18"></i></a>';
                            }
                        } else {
                            if (row.Role_Id == "5") {
                                html += '<a onclick="Edit_Safety_Violation(' + row.Safety_Violation_Id + ',' + "'" + 'Edit' + "'" + ',' + "'" + 'Access' + "'" + ')" href="javascript:void(0);" title="Edit" class="text-success" data-bs-original-title="Edit" aria-label="Edit" style="cursor: pointer;"> <i class="mdi mdi-pencil font-size-18"></i></a>';
                    ...
                    if (data == "Completed") {
                        html += '<a onclick="Edit_Safety_Violation(' + row.Safety_Violation_Id + ',' + "'" + 'View' + "'" + ',' + "'" + 'Access' + "'" + ')" href="javascript:void(0);" title="View" class="text-success" data-bs-original-title="View" aria-label="View" style="cursor: pointer;"> <i class="mdi mdi-eye font-size-18"></i></a>';
                        html += '<a onclick="Fn_Insp_SV_Report(' + row.Safety_Violation_Id + ',' + "'" + row.Unique_Id + "'" + ')" style="cursor: pointer;"><i style="color: red;font-size: 18px" class="mdi mdi-file-pdf"></i></a>';
                    }
                    return html;
                }
            },
...
function Fn_Insp_SV_Report(id, Unique_Id) {
    ...
    $(".preloader").show();
    $("#List_Grid_Div").hide();
    $.post("/InspReport/Insp_Safety_Violation_Report", { Safety_Violation_Id: NotiID, Unique_Id: Unique_Id }, function (data) {
        if (data) {
            window.open(data);
        }
        else {
...
function Fn_Insp_SV_Pre_Report(id, Unique_Id) {
    let NotiID = parseInt(id);
    $(".preloader").show();
    $("#List_Grid_Div").hide();
    $.post("/InspReport/Insp_Safety_Violation_Pre_Report", { Safety_Violation_Id: NotiID, Unique_Id: Unique_Id }, function (data) {
        if (data) {
            window.open(data);
        }
        else {
