...
barchartColors = getChartColorsArray("line_chart_annotations"), options = {
    series: [{
...
barchartColors = getChartColorsArray("syncingchart-line"), options = {
    series: [{
...
var data = generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 185, {
    ...
    barchartColors = getChartColorsArray("brushchart_line2"),
    options = {
        series: [{
            data: data
        }],
...
options = {
    ...
    colors: barchartColors = getChartColorsArray("line_chart_stepline")
};
...
options = {
    ...
    xaxis: {},
    colors: barchartColors = getChartColorsArray("line_chart_missing_data")
};
...
barchartColors = getChartColorsArray("line_chart_realtime"), options = {
    series: [{
        data: data.slice()
    }],
    chart: {
