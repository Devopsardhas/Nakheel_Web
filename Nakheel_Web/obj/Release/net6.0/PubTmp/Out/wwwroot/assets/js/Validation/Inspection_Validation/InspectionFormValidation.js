    ...
    $(function () {
        ...
        $("#F_Add_Insp_Request").validate({
            ...
            errorPlacement: function (label, element) {
                ...
                $("#Insp_Type_Id-error").removeClass('mt-2');
                $("#Insp_Type_Id-error").addClass('m-2 text-danger');

                $("#search_input-error").removeClass('mt-2');
                $("#search_input-error").addClass('mt-2 text-danger');

                $("#Category_Id-error").removeClass('mt-2');
                $("#Category_Id-error").addClass('m-2 text-danger');
            },
            submitHandler: function () {
                ...
                $.ajax({
                    url: "/Inspection/Insp_Request_Add",
                    type: "POST",
                    cache: false,
