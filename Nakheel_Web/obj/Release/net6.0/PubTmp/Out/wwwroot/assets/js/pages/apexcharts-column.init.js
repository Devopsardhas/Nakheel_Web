...
options = {
    ...
    colors: barchartColors = getChartColorsArray("column_stacked")
};
(chart = new ApexCharts(document.querySelector("#column_stacked"), options)).render();
options = {
    series: [{
        name: "",
        data: [44, 55, 41, 67, 22, 43, 21, 49,22,43,6,7]
    }],
    chart: {
        type: "bar",
        height: 230,
    ...
    colors: barchartColors = getChartColorsArray("column_stacked_chart")
};
    ...
    series: [{
        ...
        data: [{
            ...
            goals: [{
                ...
                value: 1400,
                strokeWidth: 5,
                strokeColor: (barchartColors = getChartColorsArray("column_markers"))[1]
            }]
        }, {
            x: "2012",
            y: 4432,
...
options = {
    ...
    annotations: {
        points: [{
            ...
            seriesIndex: 0,
            label: {
                borderColor: (barchartColors = getChartColorsArray("column_rotated_labels"))[0],
                offsetY: 0,
                style: {
                    color: "#fff",
...
options = {
    ...
    colors: barchartColors = getChartColorsArray("column_nagetive_values"),
    plotOptions: {
        bar: {
            colors: {
                ranges: [{
...
options = {
    ...
    colors: barchartColors = getChartColorsArray("column_range")
};
