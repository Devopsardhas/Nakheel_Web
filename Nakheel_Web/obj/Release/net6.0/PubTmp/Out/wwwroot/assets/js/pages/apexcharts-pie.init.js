...
var options = {
    ...
    colors: barchartColors = getChartColorsArray("updating_donut_chart")
},
...
options = {
    ...
    colors: barchartColors = getChartColorsArray("gradient_chart")
};
...
options = {
    ...
    colors: barchartColors = getChartColorsArray("pattern_chart")
};
...
options = {
    ...
    theme: {
        monochrome: {
            enabled: !0,
            color: (barchartColors = getChartColorsArray("monochrome_pie_chart"))[0],
            shadeTo: "light",
            shadeIntensity: .6
        }
    },
